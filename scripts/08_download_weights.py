"""
Step 08 — Download LazyQSAR descriptor weights.

Run this ONCE from the login node before submitting the SLURM array job (step 09).
Re-running is safe: each file is skipped if it already exists.

Usage:
    python scripts/08_download_weights.py
    python scripts/08_download_weights.py --path /custom/weights/dir
"""
