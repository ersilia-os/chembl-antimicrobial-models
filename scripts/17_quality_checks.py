...
For each pathogen, reads:
  ...
  - output/10_fixed_weights/10_reports.csv — model CV performance
  - output/10_fixed_weights/10_discarded_models.csv — models below MIN_AUROC
...
DISCARDED_PATH = os.path.join(REPO_ROOT, "output", "10_fixed_weights", "10_discarded_models.csv")
